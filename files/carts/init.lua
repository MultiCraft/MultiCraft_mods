...
minetest.register_alias("railtrack:switchrail", "carts:brakerail")
minetest.register_alias("boost_cart:detectorrail", "carts:detectorrail")
minetest.register_alias("boost_cart:startstoprail", "carts:brakerail")
minetest.register_alias("railtrack:fixer", "default:stick")
minetest.register_alias("railtrack:inspector", "default:stick")
minetest.register_alias("carts:startstoprail", "carts:brakerail")
