...
-- Default function when a player is detached from a mob
function mobs.on_detach_child(entity, child)
	if child and entity.driver == child then
		entity.driver = nil
...
local function force_detach(player)
	if player and player:get_attach() then
		-- The on_detach_child callback should do the rest of the cleaning up
		player:set_detach()
	end
end
